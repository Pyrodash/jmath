...
impl<'a> Lexer<'a> {
    ...
    fn read(&mut self) -> Option<Token<'a>> {
        ...
        match self.peek() {
            ...
            "{" => Some(self.atom(TokenKind::BlockStart)),
            "}" => Some(self.atom(TokenKind::BlockEnd)),
            "," => Some(self.atom(TokenKind::Separator)),
            ":" => Some(self.atom(TokenKind::Colon)),
...
impl fmt::Display for TokenKind {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            TokenKind::BlockStart => write!(f, "BlockStart"),
            TokenKind::BlockEnd => write!(f, "BlockEnd"),
